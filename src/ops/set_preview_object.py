"""
MELVIL_OT_set_preview_object — set the material preview mesh preference.
...
class MELVIL_OT_set_preview_object(bpy.types.Operator):
    """Set the mesh object used for material preview images"""

    bl_idname = "melvil.set_preview_object"
